    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('OW', 'Office Wear'), ('CW', 'Casual Wear'), ('EW', 'Ethinc Wear'), ('SW', 'Sports Wear')], max_length=2)),
